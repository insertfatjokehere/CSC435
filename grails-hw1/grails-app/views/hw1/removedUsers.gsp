...
<body>
 %{--<div style="text-align:left;"><a href="/hw1/dash">Home </a> &rArr; <a href="/hw1/getAllFollowers">Manage sers </a><span style="float:right;"><a href="/hw1/logout.jsp">logout</a></span></div>--}%
%{--<hr>--}%
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/hw1/getAllFollowers">Manage Followers <span class="sr-only">(current)</span></a></li>
            </ul>
