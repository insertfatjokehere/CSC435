...
public class GetKeyResponse {
    ...
    @XmlElementRef(name = "GetKeyResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> getKeyResult;
     ...
     *     
     */
    public JAXBElement<String> getGetKeyResult() {
        return getKeyResult;
    }
     ...
     *     
     */
    public void setGetKeyResult(JAXBElement<String> value) {
