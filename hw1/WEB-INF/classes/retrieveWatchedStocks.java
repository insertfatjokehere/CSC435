...
@WebServlet("/retrieveWatchedStocks")
public class retrieveWatchedStocks extends HttpServlet {
   	...
   	protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
               ...
               RequestDispatcher view = request.getRequestDispatcher("/viewYourStocks.jsp");
               String user = null;
               try {
